...
<body>
    ...
    <nav class="main-nav">
        ...
        <a href="http://localhost/web_dev_3/pages/Home.php">
            <h2 class="logo"><img src="http://localhost/web_dev_3/public/img/logo.png" style="width: 5rem;" alt="skillUpNow"></h2>
        </a>
            ...
            <?php } else { ?>
                ...
                <ul class="main-nav-list">
                    ...
                    <li>
                        <a href='' class='main-nav-link' onclick="window.location.href = 'http://localhost/web_dev_3/pages/formateur/signup.php';">Devenir Formateur</a>
                    </li>
                    <li>
