...
<div class="cards-container">
    <div class="card" onclick="window.location.href = 'http://localhost/web_dev_3/pages/course_detail.php';" style="border: none;" data-lecture='http://localhost/web_dev_3/pages/content/course1/watch.php'>
        <img src="../public/img/code.jpg" alt="">
        <div class="title">
            <p>100 days of code</p>
            <p class="teacher">Angela Yu</p>
            <div>
                <p class="price"><?php echo $prix?>.000 francs</p>
